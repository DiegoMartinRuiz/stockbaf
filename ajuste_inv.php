                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <form action="reg_ajus.php" method="post" enctype="multipart/form-data" id="import_form"></br>
                                <table>
                                    <td>
                                        <label> Ingresar Numero de Serie dar de Baja</label></br>
                                    ...
                                    <td>
                                        <label>Motivo de la Baja</label></br>
