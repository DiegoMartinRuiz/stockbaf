                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <table>
                                <td>
                                    <form action="consulta_toa_ot.php" method="post" enctype="multipart/form-data" id="import_form"></br>
                                        <input type="text" name="ot" /></br>
                                        </br>
                                        </br>
                                        <input type="submit"  name="consultarr_data" value="Consultar Orden de Trabajo..."></p>
                                    </form>
                                </td>
                        ...
                        <div class="row">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT `id_toa`,`ordentrabajo`,`desc_tramite`,`desc_mat`,`num_serie`,`cant`, `tecnico`, `centro`, `f_informado` FROM `historial` WHERE `ordentrabajo`='$ot' ";
